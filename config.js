...
module.exports = {
    ...
    ownernumber: process.env.Owner_Number || "2349071581298",
    instagramId: process.env.Insta || "ogbuaku jesse",
    ...
    mongoUrl: process.env.MongoDB || "mongosh "mongodb+srv://cluster0.p5umc.mongodb.net/" --apiVersion 1 --username <db_username>",
    sessionId: process.env.SESSION_ID || "d2l1NnJ_Queen-Anya_kNjU=",
